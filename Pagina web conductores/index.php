...
<body>
   ...
   <?php
        ...
        if(isset($_GET['page'])){
            ...
            if($_GET['page'] == 'r_conductores' && isset($_SESSION["auth"])) {
                
                include('Registro/conductor.php');
            }
           
            if($_GET['page'] == 'admins' && isset($_SESSION["auth"])) {
                include('Listado/listado_admin.php');
            }
            if($_GET['page'] == 'conductores' && isset($_SESSION["auth"])) {
                include('Listado/listado_conductores.php');
            }
